...
class GrowthRecord {
  ...
  final bool isSyncedToBackend;  // tracks whether backend copy was sent
  ...
  /// Parse a Firestore document into a GrowthRecord.
  /// Used when loading records from Firestore (online or from local cache).
  ...
  // JSON (for optional backend sync copy)
