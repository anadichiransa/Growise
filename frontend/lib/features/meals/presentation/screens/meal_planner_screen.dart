      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: CircleAvatar(radius: 17, backgroundColor: _soft,
              child: const Icon(Icons.person, color: _textSub, size: 18)),
          ),
        ],
      ),
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: const Icon(Icons.history, color: _textSub, size: 18),
                    ),
                  ),
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(color: _purple.withOpacity(0.6),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Liked foods ──────────────────────────────────
                    _Label('Foods Baby Likes', Icons.favorite_rounded, _green),
                    const SizedBox(height: 8),
                    // Key fix: Obx returns the widget directly, no nested Obx inside selector
                    ...
                    // ── Disliked foods ───────────────────────────────
                    _Label('Foods Baby Refuses', Icons.block_rounded, _red),
                    ...
                    // ── Cooking methods ──────────────────────────────
                    _Label('Preferred Cooking',
                      Icons.local_fire_department_rounded, _accent),
                    const SizedBox(height: 4),
                    ...
                    const Center(
                      child: Text(
                        'Not the right age group? Adjust the slider above.',
                        style: TextStyle(color: _textSub, fontSize: 11)),
                    ),
                    const SizedBox(height: 20),
