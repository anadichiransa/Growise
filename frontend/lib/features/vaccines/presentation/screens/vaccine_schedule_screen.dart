...
class _VaccineScheduleScreenState extends State<VaccineScheduleScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<VaccineController>().loadSchedule(widget.childId);
    });
  }
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isDueNow = group.vaccines.any((v) =>
                        v.status == 'pending' &&
                        v.daysUntilDue != null &&
                        v.daysUntilDue! <= 0);
                    final isLocked =
                        group.ageMonths > widget.childAgeMonths + 1;
                    return Column(
                      ...
                      children: [
                        ...
                        ...group.vaccines.map((vaccine) => VaccineCard(
                              record: vaccine,
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(widget.childName,
                style: const TextStyle(
                    ...
                    fontWeight: FontWeight.bold,
                    fontSize: 16)),
            Text('${widget.childAgeMonths} Months Old',
  ...
  void _showMarkDoneSheet(vaccine) {
    showModalBottomSheet(
      ...
      builder: (_) => MarkDoneBottomSheet(
        ...
        onSubmit: (data) {
          context
              .read<VaccineController>()
              .markVaccineDone(widget.childId, vaccine.vaccineId, data);
        },
      ),
    );
  }
