...
class VaccineDetailsSheet extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            if (record.administeredDate != null)
              _section('Administered Date', _formatDate(record.administeredDate)),
            if (record.administeredBy != null)
              _section('Given At', record.administeredBy!),
            const SizedBox(height: 16),
            const Divider(color: Colors.white12),
            const SizedBox(height: 12),
            const Text('Side Effects Info',
  ...
  Widget _chip(String label) => Container(
    ...
    decoration: BoxDecoration(color: const Color(0xFF5C35CC),
