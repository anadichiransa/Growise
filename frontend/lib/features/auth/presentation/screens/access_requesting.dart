...
import 'package:growise/features/dashboard/presentation/controllers/permission_controller.dart';
...
class _SwirlPainter extends CustomPainter {
  ...
  void _drawCurve(Canvas canvas, Size size, Paint paint, double offset) {
    final path = Path();
